...
//import SwitcherThree from '../../../components/SwitcherThree.tsx';
//import { useActions } from '../../../hooks/useActions.ts';
//import { useEffect } from 'react';

const EditUserPage: React.FC  = async () => {
 // const {userId} = useParams();
  const navigate = useNavigate();
  //const { GetUser, EditUser} = useActions();
  //const { selectedUser } = useTypedSelector((store) => store.UserReducer);

  //console.log("EditUserPage",  userId);
  // useEffect(() => {
  ...
  return (
    <>
      ...
      {/*            /!*</div>*!/*/}
                  ...
                  {/*//email + confirmed*/}
      {/*            /!*<div className="b-5.5 flex flex-col gap-5.5 sm:flex-row">*!/*/}
